...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Review.upvote_count'
        db.add_column(u'politiburo_review', 'upvote_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Review.upvote_count'
        db.delete_column(u'politiburo_review', 'upvote_count')
