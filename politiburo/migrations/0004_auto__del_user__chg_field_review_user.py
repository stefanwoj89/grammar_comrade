...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'politiburo_review', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Review.user'
        db.alter_column(u'politiburo_review', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['politiburo.User']))
